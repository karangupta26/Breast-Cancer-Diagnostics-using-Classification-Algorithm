...
train_path="A:\\Projects\\Major Project\\CNN New\\InceptionV3\\train"
test_path="A:\\Projects\\Major Project\\CNN New\\InceptionV3\\test"
...
# Training Paths 
data_train=np.load(train_path+"\\data_cnn_InceptionV3_train.npy")
filenames_train=np.load(train_path+"\\data_filenames_InceptionV3_train.npy")
mag_train=np.load(train_path+"\\data_mag_InceptionV3_train.npy")
cancerclass_train=np.load(train_path+"\\data_cancerclass_InceptionV3_train.npy")
cancertype_train=np.load(train_path+"\\data_cancertype_InceptionV3_train.npy")

# Testing Paths 
data_test=np.load(test_path+"\\data_cnn_InceptionV3_test.npy")
filenames_test=np.load(test_path+"\\data_filenames_InceptionV3_test.npy")
mag_test=np.load(test_path+"\\data_mag_InceptionV3_test.npy")
cancerclass_test=np.load(test_path+"\\data_cancerclass_InceptionV3_test.npy")
cancertype_test=np.load(test_path+"\\data_cancertype_InceptionV3_test.npy")
...
#Saving Paths
save_train_path="A:\\Projects\\Major Project\\Extracted CNN Features\\InceptionV3\\train"
save_test_path="A:\\Projects\\Major Project\\Extracted CNN Features\\InceptionV3\\test"
...
np.save(save_train_path+"\\data_cnn_InceptionV3_train.npy",data_train)
np.save(save_train_path+"\\data_filenames_InceptionV3_train.npy",filenames_train)
np.save(save_train_path+"\\data_mag_InceptionV3_train.npy",mag_train)
np.save(save_train_path+"\\data_cancerclass_InceptionV3_train.npy",cancerclass_train)
np.save(save_train_path+"\\data_cancertype_InceptionV3_train.npy",cancertype_train)


# In[17]:


np.save(save_test_path+"\\data_cnn_InceptionV3_test.npy",new_data_test)
np.save(save_test_path+"\\data_filenames_InceptionV3_test.npy",new_filenames_test)
np.save(save_test_path+"\\data_mag_InceptionV3_test.npy",new_mag_test)
np.save(save_test_path+"\\data_cancerclass_InceptionV3_test.npy",new_cancerclass_test)
np.save(save_test_path+"\\data_cancertype_InceptionV3_test.npy",new_cancertype_test)
