...
train_path="A:\\Projects\\Major Project\\CNN New\\Xception\\train"
test_path="A:\\Projects\\Major Project\\CNN New\\Xception\\test"
...
# Training Paths 
data_train=np.load(train_path+"\\data_cnn_Xception_train.npy")
filenames_train=np.load(train_path+"\\data_filenames_Xception_train.npy")
mag_train=np.load(train_path+"\\data_mag_Xception_train.npy")
...
# Testing Paths 
data_test=np.load(test_path+"\\data_cnn_Xception_test.npy")
filenames_test=np.load(test_path+"\\data_filenames_Xception_test.npy")
mag_test=np.load(test_path+"\\data_mag_Xception_test.npy")
...
#Saving Paths
save_train_path="A:\\Projects\\Major Project\\Extracted CNN Features\\Xception\\train"
save_test_path="A:\\Projects\\Major Project\\Extracted CNN Features\\Xception\\test"
...
np.save(save_train_path+"\\data_cnn_Xception_train.npy",data_train)
np.save(save_train_path+"\\data_filenames_Xception_train.npy",filenames_train)
np.save(save_train_path+"\\data_mag_Xception_train.npy",mag_train)
np.save(save_train_path+"\\data_cancerclass_Xception_train.npy",cancerclass_train)
np.save(save_train_path+"\\data_cancertype_Xception_train.npy",cancertype_train)


# In[17]:


np.save(save_test_path+"\\data_cnn_Xception_test.npy",new_data_test)
np.save(save_test_path+"\\data_filenames_Xception_test.npy",new_filenames_test)
np.save(save_test_path+"\\data_mag_Xception_test.npy",new_mag_test)
np.save(save_test_path+"\\data_cancerclass_Xception_test.npy",new_cancerclass_test)
np.save(save_test_path+"\\data_cancertype_Xception_test.npy",new_cancertype_test)
